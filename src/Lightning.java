...
public class Lightning implements TowerModelI {
    ...
    public void fire(EnemyModel target) {
        ...
        if (!hasFiredOnce || currentTime - lastFiredTime >= fireCooldown) {
            ...
            if (target != null) {
                Projectile newProjectile = new Projectile("default", "Images/TowerSprites/LightningProjectile.png", 50, this.xLoc, this.yLoc, target);
